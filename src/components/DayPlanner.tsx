...
export function DayPlanner({ open, onClose }: DayPlannerProps) {
	...
	return (
		<SlideInPanel open={open} onClose={onClose} ariaLabel={t("day_planner.title")} className="w-[380px] max-w-[92vw]">
			{/* Header */}
			<div className="flex items-center justify-between px-5 pt-4 pb-3">
				<h2 className="text-sm font-medium text-text-primary flex items-center gap-2">
					<Clock size={14} className="text-accent-primary" /> {t("day_planner.title")}
				</h2>
                           ...
                           border border-border-default focus:border-accent-primary/30 transition-colors font-sans ${FOCUS_RING}`}
							...
							<div className="flex gap-2">
								<div className="flex-1">
										<label className="text-[9px] text-text-quaternary block mb-1">
										{t("day_planner.start")}
									</label>
									<input
										type="time"
